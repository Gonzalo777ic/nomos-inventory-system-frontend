...
const AnnouncementsPage: React.FC = () => {
  ...
  const requestDelete = (id: number) => {
    setConfirmState({
      ...
      message:
        "Esta acción es irreversible. El anuncio dejará de ser visible inmediatamente.",
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Gestiona los avisos visibles para los usuarios del sistema.
          </p>
        </div>
        <button
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-6 border border-gray-200 dark:border-gray-700 scale-100 transform transition-all">
            <div className="flex flex-col items-center text-center gap-4">
              <div
                className={`p-3 rounded-full ${confirmState.confirmBtnStyle === "danger" ? "bg-red-100 text-red-600" : "bg-amber-100 text-amber-600"}`}
              >
